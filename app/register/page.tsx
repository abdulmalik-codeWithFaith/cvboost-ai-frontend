...
export default function RegisterPage() {
  return (
    <div className="min-h-screen flex items-center justify-center  bg-[#05070f] overflow-x-hidden">
      ...
      {/* Card */}
      <div
        className="relative z-10 w-full  flex flex-col lg:flex-row min-h-[820px] rounded-2xl overflow-hidden shadow-2xl"
        style={{
