    ...
    <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-10 relative z-10 bg-[#10131c]/50 backdrop-blur-sm">
      ...
      <div className="w-full max-w-[420px] mt-14 lg:mt-0">
        ...
        <div className="text-center mb-8">
          <h2
            className="text-3xl font-bold text-[#e1e2ee] mb-1.5"
            style={{ letterSpacing: "-0.01em" }}
          >
            Welcome Back
          </h2>
          <p className="text-[#8d90a0] text-sm">Sign in to continue optimizing.</p>
        </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <Link
                ...
                className="text-xs text-[#b4c5ff] hover:text-[#4cd7f6] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
